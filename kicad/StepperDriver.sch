...
U 1 1 5DAF219E
P 2500 6200
F 0 "#PWR050" H 2500 5950 50  0001 C CNN
...
F 3 "https://www.mouser.se/datasheet/2/303/APC-1-15.34-911303.pdf" H 2700 2600 50  0001 C CNN
F 4 "APC0805B10K0N" H 2700 2600 50  0001 C CNN "MPN"
	1    2700 2600
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "B540C" V 7595 1679 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 7550 1600 50  0001 C CNN
...
F 1 "B540C" V 8050 1400 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 8000 1600 50  0001 C CNN
...
F 1 "B540C" V 7595 2229 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 7550 2150 50  0001 C CNN
...
F 1 "B540C" V 8050 1950 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 8000 2150 50  0001 C CNN
...
F 4 "MCP6L02T-E/SN" H 8900 4900 50  0001 C CNN "MPN"
	2    8900 4900
	1    0    0    -1  
$EndComp
$Comp
...
F 3 "https://www.mouser.se/datasheet/2/418/NG_DS_1773204-3_1-1358553.pdf" H 8850 5250 50  0001 C CNN
F 4 "CRGCQ0805F100K" H 8850 5250 50  0001 C CNN "MPN"
	1    8850 5250
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 4 "MCP4251-503E/SL" H 7900 5750 50  0001 C CNN "MPN"
	1    7900 5750
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5DA869CE" Ref="#PWR047"  Part="1" 
F 0 "#PWR047" H 8400 5400 50  0001 C CNN
...
F 3 "https://www.mouser.se/datasheet/2/447/UPY-GPHC_X7R_6.3V-to-50V_18-1154002.pdf" H 7350 5450 50  0001 C CNN
F 4 "CC0805KRX7R9BB104" H 7350 5450 50  0001 C CNN "MPN"
	1    7350 5450
	1    0    0    -1  
$EndComp
Wire Wire Line
...
AR Path="/5DA869E8" Ref="#PWR044"  Part="1" 
F 0 "#PWR044" H 7250 5350 50  0001 C CNN
...
AR Path="/5DA869FD" Ref="#PWR049"  Part="1" 
F 0 "#PWR049" H 8400 5900 50  0001 C CNN
...
F 1 "B540C" V 9895 1679 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 9850 1600 50  0001 C CNN
...
F 1 "B540C" V 10350 1400 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 10300 1600 50  0001 C CNN
...
F 1 "B540C" V 9895 2229 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 9850 2150 50  0001 C CNN
...
F 1 "B540C" V 10350 1950 50  0000 L CNN
F 2 "Diode_SMD:D_SMC_Handsoldering" H 10300 2150 50  0001 C CNN
...
F 4 "MCP6L02T-E/SN" H 10050 4900 50  0001 C CNN "MPN"
	2    10050 4900
	-1   0    0    -1  
$EndComp
$Comp
...
F 3 "https://www.mouser.se/datasheet/2/418/NG_DS_1773204-3_1-1358553.pdf" H 10000 5250 50  0001 C CNN
F 4 "CRGCQ0805F100K" H 10000 5250 50  0001 C CNN "MPN"
	1    10000 5250
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 5DD9D3D2
P 850 5400
F 0 "#PWR043" H 850 5250 50  0001 C CNN
...
U 1 1 5DDC0478
P 850 5850
F 0 "R25" H 920 5896 50  0000 L CNN
F 1 "?R" H 920 5805 50  0000 L CNN
...
U 1 1 5DDC2421
P 850 6000
F 0 "#PWR048" H 850 5750 50  0001 C CNN
